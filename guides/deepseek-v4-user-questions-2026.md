...
![cover](https://raw.githubusercontent.com/allinherog-star/aiskillsguides/HEAD/guides/images/deepseek-v4-user-questions-2026/cover-wechat-2_35x1.webp)

## DeepSeek V4 到底上线了吗

![content-01](https://raw.githubusercontent.com/allinherog-star/aiskillsguides/HEAD/guides/images/deepseek-v4-user-questions-2026/content-01.webp)

先把最容易吵起来的问题说清楚：截至 2026 年 4 月 24 日，DeepSeek V4 已经进入官方 Preview 阶段，并且 API 文档已经列出 `deepseek-v4-pro` 和 `deepseek-v4-flash`。

这和前几个月的传闻不一样。官方新闻页写明 V4 Preview 已经 live，并说网页端可通过 Expert Mode / Instant Mode 体验；API 更新日志也写明 base_url 不变，只需要把 model 参数改成 `deepseek-v4-pro` 或 `deepseek-v4-flash`。
...
![content-02](https://raw.githubusercontent.com/allinherog-star/aiskillsguides/HEAD/guides/images/deepseek-v4-user-questions-2026/content-02.webp)
...
官方更新日志写得很明确：`deepseek-chat` 和 `deepseek-reasoner` 会在 2026 年 7 月 24 日退场。当前兼容期内，它们分别路由到 V4-Flash 的 non-thinking 和 thinking 模式。

这对开发者很重要，因为很多项目里配置的不是底层版本名，而是这两个老 alias。如果你的应用只看“接口还能返回”，很容易误以为没变化；但实际模型行为、成本结构、上下文能力和输出风格都可能已经换了底层。

建议分三步迁移：

1. 把配置里的模型名从 alias 改成显式的 `deepseek-v4-flash` 或 `deepseek-v4-pro`。
...
![content-03](https://raw.githubusercontent.com/allinherog-star/aiskillsguides/HEAD/guides/images/deepseek-v4-user-questions-2026/content-03.webp)
...
![content-04](https://raw.githubusercontent.com/allinherog-star/aiskillsguides/HEAD/guides/images/deepseek-v4-user-questions-2026/content-04.webp)
...
- 你现在用的就是 `deepseek-chat` 或 `deepseek-reasoner`，需要赶在 2026 年 7 月 24 日前完成模型名迁移。
...
1. [DeepSeek V4 Preview Release](https://api-docs.deepseek.com/news/news260424)；DeepSeek API Docs；访问日期：2026-04-24；用于确认 V4 Preview 上线、模型分档、1M 上下文、API 可用和 legacy 模型退场信息
1. [DeepSeek API Change Log](https://api-docs.deepseek.com/updates)；DeepSeek API Docs；访问日期：2026-04-24；用于确认 2026-04-24 API 更新和 deepseek-chat/deepseek-reasoner 的兼容映射
1. [Models & Pricing](https://api-docs.deepseek.com/quick_start/pricing)；DeepSeek API Docs；访问日期：2026-04-24；用于核对 V4-Pro、V4-Flash 的上下文长度、最大输出、功能和价格
1. [DeepSeek-V4-Pro model card](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro)；Hugging Face；访问日期：2026-04-24；用于核对参数规模、MoE 架构、1M context 和官方模型卡中的评测描述
1. [China's DeepSeek launches an update of its AI model](https://apnews.com/article/deepseek-ai-china-gpt-v4-d2ed33f2521917193616e061674d5f92)；AP News；访问日期：2026-04-24；用于补充外部媒体视角、行业评价和独立评测提醒
